    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <form action="{{ route('saveUpdateAdminEtudiant') }}" method="POST" class="form-group">
                    @csrf
                    <br>

                        <input type="hidden" name="id" value="{{$etudiant->idEtd}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="Email" name="email" value="{{$etudiant->user->email}}">

                        </div>

                        <div class="form-group">
                            <label for="Password">Mot de passe</label>
                            <input type="text" class="form-control" id="Password" name="password" value="{{$etudiant->user->password}}">
